...
import { CardTransactionComponent } from 'app/entities/card-transaction/card-transaction.component';
...
describe('Component Tests', () => {
  describe('CardTransaction Management Component', () => {
    let comp: CardTransactionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CardTransactionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cardTransactions && comp.cardTransactions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
