...
import { AttatchmentComponent } from 'app/entities/attatchment/attatchment.component';
...
describe('Component Tests', () => {
  describe('Attatchment Management Component', () => {
    let comp: AttatchmentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AttatchmentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.attatchments && comp.attatchments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
