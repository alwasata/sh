...
describe('Category e2e test', () => {
  ...
  it('should load Categories', async () => {
    ...
    expect(await categoryComponentsPage.getTitle()).to.eq('sahatiApp.category.home.title');
  ...
  it('should load create Category page', async () => {
    ...
    expect(await categoryUpdatePage.getPageTitle()).to.eq('sahatiApp.category.home.createOrEditLabel');
  ...
  it('should create and save Categories', async () => {
    ...
    await promise.all([categoryUpdatePage.setNameArInput('nameAr'), categoryUpdatePage.setNameEnInput('nameEn')]);

    expect(await categoryUpdatePage.getNameArInput()).to.eq('nameAr', 'Expected NameAr value to be equals to nameAr');
    expect(await categoryUpdatePage.getNameEnInput()).to.eq('nameEn', 'Expected NameEn value to be equals to nameEn');
  ...
  it('should delete last Category', async () => {
    ...
    expect(await categoryDeleteDialog.getDialogTitle()).to.eq('sahatiApp.category.delete.question');
