    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id='sahatiApp.employee.home.createOrEditLabel'>Create or edit a Employee</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class='form-control-label' for='employee-name'>Name</label>
                    ...
                    <div class="form-group">
                        <label class='form-control-label' for='employee-phone'>Phone</label>
                    ...
                    <div class="form-group">
                        <label class='form-control-label' for='employee-identityNo'>Identity No</label>
                    ...
                    <div class="form-group">
                        <label class='form-control-label' for='employee-employeeStatus'>Employee Status</label>
                    ...
                    <div class="form-group">
                        <label class='form-control-label' for='employee-notes'>Notes</label>
                    ...
                    <div class='form-group'>
                        <label class='form-control-label' for='employee-company'>Company</label>
