        ...
        <div>
          ...
          <div class="form-group">
            ...
            <input
              ...
              class="form-control"
              name="identityNo"
              id="employee-identityNo"
              :class="{ valid: !$v.employee.identityNo.$invalid, invalid: $v.employee.identityNo.$invalid }"
              v-model="$v.employee.identityNo.$model"
            />
          ...
          <div class="form-group">
            ...
            <input
              ...
              name="notes"
              id="employee-notes"
              :class="{ valid: !$v.employee.notes.$invalid, invalid: $v.employee.notes.$invalid }"
              v-model="$v.employee.notes.$model"
            />
          </div>
          ...
          <div class="form-group">
            ...
            <div>
              <div v-if="attatchment.file" class="clearfix">
                <a class="pull-left" v-on:click="openFile(attatchment.fileContentType, attatchment.file)"> اضغط هنا لعرض المرفق</a><br />
                <span class="pull-left">{{ attatchment.fileContentType }}, {{ byteSize(attatchment.file.data) }}</span>
                <button
                  type="button"
                  v-on:click="
                    attatchment.file = null;
                    attatchment.fileContentType = null;
                  "
              ...
              <input id="file_file" ref="file_file" type="file" v-on:change="setFileData($event, attatchment, 'file', false)" />
            </div>
            <input
              type="hidden"
              class="form-control"
              name="file"
              id="attatchment-file"
              :class="{ valid: !$v.attatchment.file.$invalid, invalid: $v.attatchment.file.$invalid }"
              v-model="$v.attatchment.file.$model"
            />
            <input
              type="hidden"
              class="form-control"
              name="fileContentType"
              id="attatchment-fileContentType"
