    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id='sahatiApp.hospital.home.createOrEditLabel'>Create or edit a Hospital</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class='form-control-label' for='hospital-nameAr'>Name Ar</label>
                        <input type="text" class="form-control" name="nameAr" id="hospital-nameAr"
                    ...
                    <div class="form-group">
                        <label class='form-control-label' for='hospital-nameEn'>Name En</label>
                    ...
                    <div class="form-group">
                        <label class='form-control-label' for='hospital-email'>Email</label>
                    ...
                    <div class="form-group">
                        <label class='form-control-label' for='hospital-phone'>Phone</label>
                    ...
                    <div class="form-group">
                        <label class='form-control-label' for='hospital-address'>Address</label>
