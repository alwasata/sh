<template>
    <div>
        ...
        <div class="table-responsive" v-if="invoices && invoices.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th v-on:click="changeOrder('invoiceStatus')"><span>Invoice Status</span>
                    ...
                    <th v-on:click="changeOrder('cardTransaction.id')"><span>Card Transaction</span>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot='modal-title'><span id='sahatiApp.invoice.delete.question'>Confirm delete operation</span></span>
            ...
            <div slot='modal-footer'>
                ...
                <button id='jhi-confirm-delete-invoice' class='btn btn-primary' type='button'
                        v-on:click='removeInvoice()'>Delete
                </button>
            </div>
        </b-modal>
