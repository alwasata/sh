            ...
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/attatchment">
                        ...
                        <span v-text="$t('global.menu.entities.attatchment')">Attatchment</span>
                    </b-dropdown-item>
                    ...
                    <b-dropdown-item to="/card">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.card')">Card</span>
                    </b-dropdown-item>
                    ...
                    <b-dropdown-item to="/hospital">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.hospital')">Hospital</span>
                    </b-dropdown-item>
                    ...
                    <b-dropdown-item to="/benefit">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.benefit')">Benefit</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/benefit-request">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.benefitRequest')">BenefitRequest</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/card-transaction">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.cardTransaction')">CardTransaction</span>
                    </b-dropdown-item>
                    ...
                    <b-dropdown-item to="/invoice-benefits">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.invoiceBenefits')">InvoiceBenefits</span>
                    </b-dropdown-item>
