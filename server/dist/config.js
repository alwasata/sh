...
class Config {
    constructor(properties) {
        ...
        this['jhipster.clientApp.name'] = 'sahati';
        ...
        this['jhipster.mail.from'] = 'sahati@localhost';
        this['jhipster.swagger.default-include-pattern'] = '/api/.*';
        this['jhipster.swagger.title'] = 'sahati API';
        this['jhipster.swagger.description'] = 'sahati API documentation';
        ...
        this['eureka.instance.appname'] = 'sahati';
        this['eureka.instance.instanceId'] = 'sahati:${random.value}';
