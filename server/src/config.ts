...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8080';
    'jhipster.clientApp.name' = 'sahati';
    ...
    'jhipster.mail.from' = 'sahati@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'sahati API';
    'jhipster.swagger.description' = 'sahati API documentation';
    ...
    'eureka.instance.appname' = 'sahati';
    'eureka.instance.instanceId' = 'sahati:${random.value}';
