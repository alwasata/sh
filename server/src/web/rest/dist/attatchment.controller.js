...
exports.AttatchmentController = void 0;
var common_1 = require("@nestjs/common");
var swagger_1 = require("@nestjs/swagger");
var attatchment_dto_1 = require("../../service/dto/attatchment.dto");
...
var AttatchmentController = /** @class */ (function () {
    function AttatchmentController(attatchmentService) {
        this.attatchmentService = attatchmentService;
        this.logger = new common_1.Logger('AttatchmentController');
    }
    AttatchmentController.prototype.getAll = function (req) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.attatchmentService.findAndCount({
    ...
    AttatchmentController.prototype.getOne = function (id) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.attatchmentService.findById(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    AttatchmentController.prototype.post = function (req, attatchmentDTO) {
        return __awaiter(this, void 0, Promise, function () {
            var created;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.attatchmentService.save(attatchmentDTO)];
                    case 1:
                        created = _a.sent();
    ...
    AttatchmentController.prototype.put = function (req, attatchmentDTO) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        header_util_1.HeaderUtil.addEntityCreatedHeaders(req.res, 'Attatchment', attatchmentDTO.id);
                        return [4 /*yield*/, this.attatchmentService.update(attatchmentDTO)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    AttatchmentController.prototype.deleteById = function (req, id) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        header_util_1.HeaderUtil.addEntityDeletedHeaders(req.res, 'Attatchment', id);
                        return [4 /*yield*/, this.attatchmentService.deleteById(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ], AttatchmentController.prototype, "getAll");
    __decorate([
        common_1.Get('/:id'),
        security_1.Roles(security_1.RoleType.USER),
        swagger_1.ApiResponse({
    ...
    ], AttatchmentController.prototype, "getOne");
    __decorate([
        common_1.Post('/'),
    ...
    ], AttatchmentController.prototype, "post");
    __decorate([
        common_1.Put('/'),
        security_1.Roles(security_1.RoleType.ADMIN),
        ...
        __param(0, common_1.Req()), __param(1, common_1.Body())
    ], AttatchmentController.prototype, "put");
    __decorate([
        common_1.Delete('/:id'),
        security_1.Roles(security_1.RoleType.ADMIN),
    ...
    ], AttatchmentController.prototype, "deleteById");
