...
var category_dto_1 = require("../../service/dto/category.dto");
...
var CategoryController = /** @class */ (function () {
    ...
    CategoryController.prototype.getAll = function (req) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.categoryService.findAndCount({
    ...
    CategoryController.prototype.post = function (req, categoryDTO) {
        return __awaiter(this, void 0, Promise, function () {
            var created;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.categoryService.save(categoryDTO)];
                    case 1:
                        created = _a.sent();
    ...
    CategoryController.prototype.put = function (req, categoryDTO) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        header_util_1.HeaderUtil.addEntityCreatedHeaders(req.res, 'Category', categoryDTO.id);
                        return [4 /*yield*/, this.categoryService.update(categoryDTO)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    CategoryController.prototype.deleteById = function (req, id) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        header_util_1.HeaderUtil.addEntityDeletedHeaders(req.res, 'Category', id);
                        return [4 /*yield*/, this.categoryService.deleteById(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    __decorate([
        ...
        __param(0, common_1.Req()), __param(1, common_1.Body())
    ], CategoryController.prototype, "put");
    __decorate([
        common_1.Delete('/:id'),
        security_1.Roles(security_1.RoleType.USER),
