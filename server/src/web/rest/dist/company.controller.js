...
var company_dto_1 = require("../../service/dto/company.dto");
...
var CompanyController = /** @class */ (function () {
    function CompanyController(companyService, userService) {
        this.companyService = companyService;
        this.userService = userService;
        this.logger = new common_1.Logger('CompanyController');
    }
    CompanyController.prototype.getAll = function (req) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.companyService.findAndCount({
    ...
    CompanyController.prototype.getOne = function (id) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.companyService.findById(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    CompanyController.prototype.post = function (req, companyDTO) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.companyService.save(companyDTO)];
                    case 2:
                        created = _a.sent();
    ...
    CompanyController.prototype.put = function (req, companyDTO) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        header_util_1.HeaderUtil.addEntityCreatedHeaders(req.res, 'Company', companyDTO.id);
                        return [4 /*yield*/, this.companyService.update(companyDTO)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    CompanyController.prototype.deleteById = function (req, id) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        header_util_1.HeaderUtil.addEntityDeletedHeaders(req.res, 'Company', id);
                        return [4 /*yield*/, this.companyService.deleteById(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ], CompanyController.prototype, "getAll");
    __decorate([
        common_1.Get('/:id'),
        security_1.Roles(security_1.RoleType.ADMIN),
        swagger_1.ApiResponse({
    ...
    ], CompanyController.prototype, "getOne");
    __decorate([
        common_1.Post('/'),
        security_1.Roles(security_1.RoleType.ADMIN),
    ...
    ], CompanyController.prototype, "post");
    __decorate([
        common_1.Put('/'),
        security_1.Roles(security_1.RoleType.ADMIN),
        ...
        __param(0, common_1.Req()), __param(1, common_1.Body())
    ], CompanyController.prototype, "put");
    __decorate([
        common_1.Delete('/:id'),
        security_1.Roles(security_1.RoleType.ADMIN),
