...
exports.UserJWTController = void 0;
var common_1 = require("@nestjs/common");
var logging_interceptor_1 = require("../../client/interceptors/logging.interceptor");
var swagger_1 = require("@nestjs/swagger");
var UserJWTController = /** @class */ (function () {
    function UserJWTController(authService) {
        this.authService = authService;
        this.logger = new common_1.Logger('UserJWTController');
    }
    UserJWTController.prototype.authorize = function (req, user, res) {
        return __awaiter(this, void 0, Promise, function () {
            var jwt;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authService.login(user)];
                    case 1:
                        jwt = _a.sent();
                        res.setHeader('Authorization', 'Bearer ' + jwt.id_token);
                        return [2 /*return*/, res.json(jwt)];
                }
            });
        });
    };
    ...
    ], UserJWTController.prototype, "authorize");
