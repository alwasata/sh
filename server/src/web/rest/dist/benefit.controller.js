...
var BenefitController = /** @class */ (function () {
    function BenefitController(benefitService, hospitalService, benefitRequestService) {
        this.benefitService = benefitService;
        this.hospitalService = hospitalService;
        this.benefitRequestService = benefitRequestService;
        this.logger = new common_1.Logger('BenefitController');
    }
    BenefitController.prototype.getAll = function (req) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        hospital = _b.sent();
                        _b.label = 3;
                    case 3: return [4 /*yield*/, this.benefitService.findAndCount(hospital, {
    ...
    BenefitController.prototype.getOne = function (id) {
        return __awaiter(this, void 0, Promise, function () {
    ...
    BenefitController.prototype.post = function (req, benefitDTO) {
        return __awaiter(this, void 0, Promise, function () {
            var hospital_id, created, benefitRequestDTO;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.benefitService.save(benefitDTO)];
                    case 3:
                        created = _a.sent();
                        benefitRequestDTO = new benefit_request_dto_1.BenefitRequestDTO();
                        ...
                        return [4 /*yield*/, this.benefitRequestService.save(benefitRequestDTO)];
                    case 4:
                        _a.sent();
    ...
    BenefitController.prototype.put = function (req, benefitDTO) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        header_util_1.HeaderUtil.addEntityCreatedHeaders(req.res, 'Benefit', benefitDTO.id);
                        return [4 /*yield*/, this.benefitService.update(benefitDTO)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    BenefitController.prototype.deleteById = function (req, id) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        header_util_1.HeaderUtil.addEntityDeletedHeaders(req.res, 'Benefit', id);
                        return [4 /*yield*/, this.benefitService.deleteById(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ], BenefitController.prototype, "getAll");
    __decorate([
        common_1.Get('/:id'),
        security_1.Roles(security_1.RoleType.HOSPITAL_ADMIN, security_1.RoleType.ADMIN),
        swagger_1.ApiResponse({
    ...
    ], BenefitController.prototype, "getOne");
    __decorate([
        common_1.Post('/'),
        security_1.Roles(security_1.RoleType.HOSPITAL_ADMIN, security_1.RoleType.ADMIN),
    ...
    ], BenefitController.prototype, "post");
    __decorate([
        common_1.Put('/'),
        security_1.Roles(security_1.RoleType.HOSPITAL_ADMIN, security_1.RoleType.ADMIN),
        ...
        __param(0, common_1.Req()), __param(1, common_1.Body())
    ], BenefitController.prototype, "put");
    __decorate([
        common_1.Delete('/:id'),
        security_1.Roles(security_1.RoleType.HOSPITAL_ADMIN, security_1.RoleType.ADMIN),
    ...
    ], BenefitController.prototype, "deleteById");
