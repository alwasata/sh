...
exports.CardTransactionController = void 0;
...
var CardTransactionController = /** @class */ (function () {
    function CardTransactionController(cardTransactionService) {
        this.cardTransactionService = cardTransactionService;
        this.logger = new common_1.Logger('CardTransactionController');
    }
    CardTransactionController.prototype.getAll = function (req) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.cardTransactionService.findAndCount({
    ...
    CardTransactionController.prototype.getOne = function (id) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cardTransactionService.findById(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    CardTransactionController.prototype.post = function (req, cardTransactionDTO) {
        return __awaiter(this, void 0, Promise, function () {
            var created;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cardTransactionService.save(cardTransactionDTO)];
                    case 1:
                        created = _a.sent();
    ...
    CardTransactionController.prototype.put = function (req, cardTransactionDTO) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        header_util_1.HeaderUtil.addEntityCreatedHeaders(req.res, 'CardTransaction', cardTransactionDTO.id);
                        return [4 /*yield*/, this.cardTransactionService.update(cardTransactionDTO)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    CardTransactionController.prototype.deleteById = function (req, id) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        header_util_1.HeaderUtil.addEntityDeletedHeaders(req.res, 'CardTransaction', id);
                        return [4 /*yield*/, this.cardTransactionService.deleteById(id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ], CardTransactionController.prototype, "getAll");
    __decorate([
        common_1.Get('/:id'),
        security_1.Roles(security_1.RoleType.USER),
        swagger_1.ApiResponse({
    ...
    ], CardTransactionController.prototype, "getOne");
    __decorate([
        common_1.Post('/'),
    ...
    ], CardTransactionController.prototype, "post");
    __decorate([
        common_1.Put('/'),
        ...
        __param(0, common_1.Req()), __param(1, common_1.Body())
    ], CardTransactionController.prototype, "put");
    __decorate([
        common_1.Delete('/:id'),
        security_1.Roles(security_1.RoleType.ADMIN),
    ...
    ], CardTransactionController.prototype, "deleteById");
    ...
    return CardTransactionController;
}());
