...
export class UserDTO extends BaseDTO {
    ...
    @ApiModelProperty({ uniqueItems: true, example: 'myuser@localhost.it', description: 'User email' })
    @IsEmail()
    email: string;
    ...
    @ApiModelProperty({
      isArray: true,
      enum: ['ROLE_USER', 'ROLE_ADMIN', 'ROLE_HOSPITAL_ADMIN', 'ROLE_COMPANY_ADMIN', 'ROLE_ANONYMOUS'],
